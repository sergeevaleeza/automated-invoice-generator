...
# The fixture is generated by this same module from the exact inputs in
# golden_invoice_inputs (see tests/conftest.py and the CHANGELOG entry for
# how/why it was regenerated), so it's expected to match byte-for-byte with
# no tolerances or documented exceptions needed.
...
def test_key_cell_styling_matches_fixture(tmp_path, golden_invoice_inputs):
    ...
    # header, patient box, payment box, title, statement labels, item
    # header (fill+border), item row (currency format), subtotal/total
